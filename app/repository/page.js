...
export default function RepositoryPage(){
 ...
 return <>
  <section className="pageIntro"><div className="kicker">Knowledge layer · Sprint 6</div><h1>The Atlas repository is compiled from frozen Reference Standards.</h1><p>Cultivars, assertions, evidence, sources, taxa, relationships, and media are deterministic objects joined through stable identifiers and protected by SHA-256.</p></section>
