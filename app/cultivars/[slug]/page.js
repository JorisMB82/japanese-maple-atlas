...
export default function CultivarPage({params}){
 ...
 return <>
  ...
  <div className="notice"><strong>Canonical source:</strong> this profile is compiled from the frozen {c.referenceStandard.id} Reference Standard and protected by SHA-256. The identity plate is an editorial illustration, not authentication evidence.</div>
