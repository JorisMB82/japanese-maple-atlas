...
- **reason:** An item-level CC BY-SA 4.0 photograph of a named ‘Orange Dream’ specimen at Wojsławice Arboretum is legally and technically actionable, but no accession, determination history or propagation chain was recovered. The current evidence does not yet support transparent cultivar-level identity approval. The retail-series alternative has weaker identity support.
- **candidateStatus:**
  - `MCAND-CUL-000011-001` — retained as the strongest current lead; not approved as an Atlas asset.
  - `MCAND-CUL-000011-002` — rejected as primary for retail-only identity and insufficient whole-plant context.
...
This approval resolves C2 for CUL-000011 without creating or approving a media asset. C3 publication remains subject to protected validation and production inspection.
