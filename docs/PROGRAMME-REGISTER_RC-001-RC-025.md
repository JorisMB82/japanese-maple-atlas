...
- **Media source:** merged PR `#14`, final head `871fe5fa441a7a1743914fc9a80f378cb77008c5`, squash commit `3cf7783ce92e56d0133d3497eb5a4f704fa280fc`.
- **Media validation:** repository-quality workflow `30326599202` passed `Repository, schemas and tests`, `Native Node coverage thresholds`, and `Production build and static regression`.
...
- **Editorial contract issue:** RC-006 through RC-010 source sidecars used structured `sourceLocations` objects while the generated-source schema expected string arrays. This was corrected in the later G4 package.
